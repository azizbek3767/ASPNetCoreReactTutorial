...
export default function App() {
            ...
            {posts.map((post) => (
              <tr key={post.postId}>
                ...
                <td>
                  ...
                  <button onClick={() => {if(window.confirm(`Are you sure that you want to delete the post titled "${post.title}"?`)) deletePost(post.postId)}} className="btn btn-secondary btn-lg">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
  ...
  function onPostCreated(createdPost) {
    ...
    alert(
      `Post successfully created. After clicking OK, your new post titled "${createdPost.title}" wil show up in the table below`
    );
  ...
  function onPostUpdated(updatedPost){
    ...
    alert(`Post successfully updated. After clicking OK, look for the post with the title "${updatedPost.title} to see the updates."`);
  }
